...
public class ClientSettings {
    ...
    public static final String X_Lake_Query_ID = "X-DATABEND-QUERY-ID";
    ...
    public static final String LakeWarehouseHeader = "X-DATABEND-WAREHOUSE";
    public static final String LakeTenantHeader = "X-DATABEND-TENANT";
    public static final String LakeSQLHeader = "X-DATABEND-SQL";
    public static final String LakeQueryContextHeader = "X-DATABEND-QUERY-CONTEXT";
    private final String host;
    private final LakeSession session;
    ...
    public ClientSettings(String host) {
        this(host, LakeSession.createDefault(), DEFAULT_QUERY_TIMEOUT, DEFAULT_CONNECTION_TIMEOUT, DEFAULT_SOCKET_TIMEOUT, PaginationOptions.defaultPaginationOptions(), new HashMap<>(), null, DEFAULT_RETRY_ATTEMPTS);
    }

    public ClientSettings(String host, String database) {
        LakeSession session = new LakeSession.Builder().setDatabase(database).build();
        this.host = host;
    ...
    public ClientSettings(String host, LakeSession session,
    ...
    public static class Builder {
        ...
        public Builder setSession(LakeSession session) {
            this.session = session;
            return this;
        }
