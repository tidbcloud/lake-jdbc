...
/**
 * Lake client session configuration.
 */
public class LakeSession {
    ...
    // default
    public static LakeSession createDefault() {
        return new LakeSession(DEFAULT_DATABASE, null, null, false, false);
    }
    ...
    public static final class Builder {
        ...
        public LakeSession build() {
            return new LakeSession(database, settings, txnState, false, false);
        }
    }
}
