...
import com.tidbcloud.client.data.ColumnTypeHandler;
import com.tidbcloud.client.data.ColumnTypeHandlerFactory;
...
final class ParseJsonDataUtils {
     ...
     * output Iterable<List<Object>> : convert the input rows into LakeType and return an immutable list
     */
