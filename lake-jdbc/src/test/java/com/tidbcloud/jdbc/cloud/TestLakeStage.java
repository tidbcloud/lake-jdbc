...
public class TestLakeStage {
    @Test(groups = {"UNIT"})
    public void testLakeStage() {
        LakeStage stage = LakeStage.builder()
    ...
    @Test(groups = {"UNIT"})
    public void testLakeStageWithExternalLocation() {
        LakeStage stage = LakeStage.builder()
        ...
        stage = LakeStage.builder().externalLocationS3(ExternalLocationS3.builder().setLocation("s3://mubucket/ab/b")
