...
public class TestTypes {
    ...
    public void testGetTimestamp(boolean sameTZ)
        ...
        try (Connection connection = Utils.createConnection();
            ...
            // For timestamp (without tz), newer Lake nightly converts the input
            ...
            //   Lake converts to session tz local time, then stores without tz.
            ...
            //   Lake treats the input as session tz local time.
    ...
    public void testGetTimestampTz()
        ...
        try (Connection connection = Utils.createConnection();
            ...
            // Newer Lake versions removed timestamp_tz type, try and skip if unsupported
            try {
    ...
    public void testSetTimestamp(boolean withTz)
        ...
        try (Connection connection = Utils.createConnection();
            ...
            if (withTz) {
                // Newer Lake versions removed timestamp_tz type, skip if unsupported
                try {
