...
import com.tidbcloud.jdbc.internal.session.LakeSessionHandle;
...
public class LakeConnection implements Connection, LakeConnectionExtension {
    ...
    private final LakeSessionHandle sessionHandle;
    ...
    LakeConnection(LakeDriverUri uri, OkHttpClient httpClient) throws SQLException {
        ...
        this.sessionHandle = new LakeSessionHandle(httpClient, config, this::queryLivenesses);
    ...
    public void setHoldability(int holdability) throws SQLException {
        throw new SQLFeatureNotSupportedException("setHoldability(int holdability)");
    }
    ...
    void pingLakeServer() throws SQLException {
        ...
        try {
            ...
            while (queryPages.hasNext()) {
                if (results != null && results.getError() != null) {
                    throw AbstractLakeResultSet.resultsException(results, sql);
                }
                queryPages.advance();
