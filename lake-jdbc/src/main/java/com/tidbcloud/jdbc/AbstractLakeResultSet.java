...
abstract class AbstractLakeResultSet implements ResultSet {
    ...
    OffsetDateTime getOffsetDateTimeNotNull(Object value, LakeRawType type) throws SQLException{
        if (value instanceof OffsetDateTime) {
   ...
   ZonedDateTime getZonedDateTimeNotNull(Object value, LakeRawType type) throws SQLException{
        if (value instanceof Timestamp) {
