...
public interface LakePresignClient {
    ...
    /**
     * presignUpload file through lake api instead of presigned url, it should only be adopted if presigned url is not available
     *
