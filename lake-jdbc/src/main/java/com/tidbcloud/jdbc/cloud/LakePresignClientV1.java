...
import static com.tidbcloud.client.ClientSettings.X_DATABEND_RELATIVE_PATH;
import static com.tidbcloud.client.ClientSettings.X_DATABEND_STAGE_NAME;
import static java.lang.String.format;
import static java.util.Objects.requireNonNull;
import static java.util.concurrent.TimeUnit.MILLISECONDS;

public class LakePresignClientV1
        implements LakePresignClient
{
    ...
    private static final Logger logger = Logger.getLogger(LakePresignClientV1.class.getPackage().getName());

    public LakePresignClientV1(OkHttpClient client, String uri)
    {
