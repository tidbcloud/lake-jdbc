...
public class LakeColumnInfo {
    ...
    private final LakeRawType type;
    ...
    public LakeColumnInfo(int columnType, List<Integer> columnParameterTypes, LakeRawType type, Nullable nullable, boolean currency, boolean signed, int precision, int scale, int columnDisplaySize, String columnLabel, String columnName, String tableName, String schemaName, String catalogName) {
    ...
    public static LakeColumnInfo of(String name, LakeRawType type) {
    ...
    public static void setTypeInfo(Builder builder, LakeRawType type) {
    ...
    public static Builder newBuilder(String name, LakeRawType type) {
        return (new Builder())
                .setColumnName(name)
                .setLakeRawType(type);
    }
    ...
    public static final class Builder {
        ...
        public Builder setLakeRawType(LakeRawType type) {
            this.type = type;
            return this;
        }
        ...
        public Builder setColumnTypeSignature(LakeRawType columnTypeSignature) {
        ...
        public LakeColumnInfo build() {
            return new LakeColumnInfo(
                    columnType,
