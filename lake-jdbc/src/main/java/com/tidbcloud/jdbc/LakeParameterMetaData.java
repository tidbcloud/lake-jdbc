...
import static com.tidbcloud.jdbc.LakeResultSetMetaData.getTypeClassName;
import static java.util.Objects.requireNonNull;

class LakeParameterMetaData extends JdbcWrapper implements ParameterMetaData {
    ...
    protected LakeColumnInfo getParameter(int param) throws SQLException {
    ...
    public int isNullable(int param) throws SQLException {
        LakeColumnInfo p = getParameter(param);
        if (p == null) {
