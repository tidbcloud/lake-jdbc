...
final class PresignContext {
    ...
    static PresignContext getPresignContext(LakeConnection connection, PresignMethod method, String stageName, String fileName)
            throws SQLException {
    ...
    static PresignContext newPresignContext(Connection connection, PresignMethod method, String stageName, String fileName)
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            LakeResultSet resultSet = (LakeResultSet) statement.executeQuery(sql);
            if (resultSet.next()) {
